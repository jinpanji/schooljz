	...
	<view class="trip_page">
		<view class="cl">
			...
			<view class="msgs">
				...
				<text class="red" v-if="schoolInfo.isInAbnormal==1&&schoolInfo.isOutnAbnormal!=1">上车行程异常</text>
				<text class="red" v-if="schoolInfo.isInAbnormal==2">未上车</text>
			</view>
			<view class="msgs">
				<i></i>
				<text>下车时间：{{schoolInfo.takeTime?schoolInfo.takeTime:''}}</text>
				<text class="red" v-if="schoolInfo.isOutnAbnormal==1&&schoolInfo.isInAbnormal!=1">下车行程异常</text>
			...
			<view class="msgs">
				...
				<text class="red" v-if="homeInfo.isInAbnormal==1&&homeInfo.isOutnAbnormal!=1">上车行程异常</text>
			</view>
			<view class="msgs">
				<i></i>
				<text>下车时间：{{homeInfo.takeTime?homeInfo.takeTime:''}}</text>
				<text class="red" v-if="homeInfo.isOutnAbnormal==2">未下车</text>
				<!-- &&homeInfo.isFunction==1 -->
				<text class="red" v-if="homeInfo.isOutnAbnormal==1&&homeInfo.isInAbnormal!=1">下车行程异常</text>
